...
#define EXTIRQ_6358_CFG_SENSE(x)	(1 << (x))
#define EXTIRQ_6358_CFG_STAT(x)		(1 << (x + 4))
#define EXTIRQ_6358_CFG_CLEAR(x)	(1 << (x + 8))
#define EXTIRQ_6358_CFG_MASK(x)		(1 << (x + 12))
#define EXTIRQ_6358_CFG_BOTHEDGE(x)	(1 << (x + 16))
#define EXTIRQ_6358_CFG_LEVELSENSE(x)	(1 << (x + 20))

#define EXTIRQ_6358_CFG_CLEAR_ALL	(0xf << 8)
#define EXTIRQ_6358_CFG_MASK_ALL	(0xf << 12)
...
#define GPIO_MODE_6358_EMAC2_MII_CLK_INV (1 << 30)
#define GPIO_MODE_6358_EMAC1_MII_CLK_INV (1 << 31)
