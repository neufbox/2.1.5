...
static BOARD_PARAMETERS g_bcm96333awg =
{
    "96333AWG",                             /* szBoardId */
    BP_NOT_DEFINED,                         /* usGPIOOverlay */
...
static PBOARD_PARAMETERS g_BoardParms[] =
    {&g_bcm96338sv, &g_bcm96338l2m8m, &g_bcm96338l652m8m, &g_bcm96338gw,
     &g_bcm96338gw20p2, &g_bcm96338gw2, &g_bcm96338e4, &g_bcm96338e420p2,
     &g_bcm96332cg, &g_bcm96333awg, 0};
#endif
...
{
    "96348GW",                              /* szBoardId */
    (BP_OVERLAY_PCI | BP_OVERLAY_MII2),     /* usGPIOOverlay */
...
static BOARD_PARAMETERS g_bcm96348gw_10 =
{
    ...
    (BP_OVERLAY_PCI | BP_OVERLAY_SPI_EXT_CS |
     BP_OVERLAY_MII2),                      /* usGPIOOverlay */
...
{
    "96358VW2",                             /* szBoardId */
    BP_OVERLAY_PCI | BP_OVERLAY_SPI_EXT_CS, /* usGPIOOverlay */
...
#ifndef CONFIG_LEDS_NEUFBOX
    (BP_OVERLAY_PCI | BP_OVERLAY_SPI_EXT_CS |
     BP_OVERLAY_LED),                       /* usGPIOOverlay */
#else
    (BP_OVERLAY_PCI | BP_OVERLAY_SPI_EXT_CS |
     BP_OVERLAY_CB),                        /* usGPIOOverlay */
#endif
    BP_NOT_DEFINED,                         /* usGpioRj11InnerPair */
    BP_NOT_DEFINED,                         /* usGpioRj11OuterPair */
    BP_NOT_DEFINED,                         /* usGpioUartRts */
...
static BOARD_PARAMETERS g_bcm96358sv =
{
    "96358SV",                              /* szBoardId */
    (BP_OVERLAY_PCI | BP_OVERLAY_CB |
     BP_OVERLAY_SPI_EXT_CS | BP_OVERLAY_UART1 |
     BP_OVERLAY_LED),                       /* usGPIOOverlay */
...
static BOARD_PARAMETERS g_bcm96358gwvg =
{
    "96358GWVG",                            /* szBoardId */
    (BP_OVERLAY_PCI | BP_OVERLAY_CB |
     BP_OVERLAY_SPI_EXT_CS|BP_OVERLAY_LED), /* usGPIOOverlay */
...
static BOARD_PARAMETERS g_bcm96358adwg =
{
    "96358ADWG",                            /* szBoardId */
    (BP_OVERLAY_PCI | BP_OVERLAY_CB |
     BP_OVERLAY_SPI_EXT_CS|BP_OVERLAY_LED), /* usGPIOOverlay */
    ...
    {{BP_ENET_INTERNAL_PHY,                 /* ucPhyType */
      0x01,                                 /* ucPhyAddress */
      BP_NOT_DEFINED,                       /* usGpioPhyReset */
      BP_GPIO_27_AL,                        /* usGpioPhyLinkSpeed */
      BP_ENET_CONFIG_MDIO,                  /* usConfigType */
      BP_NOT_DEFINED,                       /* usReverseMii */
      SW_INFO_DEFAULT(1)},                  /* sw */
     {BP_ENET_EXTERNAL_SWITCH,              /* ucPhyType */
    ...
    {{BP_VOIP_MIPS,                         /* ucDspType */
      ...
      BP_NOT_DEFINED,                       /* usGpioVoip1LedFail */
      BP_NOT_DEFINED ,                      /* usGpioSlic0Relay */
      BP_NOT_DEFINED,                       /* usGpioSlic0Reset */
      BP_NOT_DEFINED,                       /* usGpioVoip2Led */
      BP_NOT_DEFINED,                       /* usGpioVoip2LedFail */
      BP_NOT_DEFINED,                       /* usGpioSlic1Relay */
      BP_NOT_DEFINED,                       /* usGpioSlic1Reset */
...
static PBOARD_PARAMETERS g_BoardParms[] =
    {&g_bcm96358vw2, &g_bcm96358vw, &g_bcm96358gwvg,
     &g_bcm96358ivwg, &g_bcm96358sv, &g_bcm96358adwg, 0};
#else
static PBOARD_PARAMETERS g_BoardParms[] =
    {&g_bcm96358vw, 0};
#endif /* CONFIG_BOARD_NEUFBOX4 */
...
static BOARD_PARAMETERS g_bcm96369pvg =
{
   ...
   (BP_OVERLAY_PCI |
    BP_OVERLAY_EPHY_LED_0 |
    BP_OVERLAY_EPHY_LED_1 |
    BP_OVERLAY_EPHY_LED_2),                   /* usGPIOOverlay */

    BP_NOT_DEFINED,                         /* usGpioRj11InnerPair */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioRj11OuterPair */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioUartRts */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioUartCts */ /* OK */

    BP_NOT_DEFINED,                         /* usGpioLedAdsl */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioLedAdslFail */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioSecLedAdsl */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioSecLedAdslFail */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioLedSesWireless */ /* ??? */
    BP_NOT_DEFINED,                         /* usGpioLedHpna */ /* OK */
    BP_GPIO_5_AH,                           /* usGpioLedWanData */ /* OK */
    BP_GPIO_5_AH,                           /* usGpioLedPpp */ /* OK */
    BP_SERIAL_GPIO_2_AH,                    /* usGpioLedPppFail */ /* OK */
    BP_SERIAL_GPIO_0_AH,                    /* usGpioLedBlPowerOn */ /* OK */
    BP_SERIAL_GPIO_1_AH,                    /* usGpioLedBlStop */ /* OK */
    BP_NOT_DEFINED,                         /* usGpioBondingSecondaryReset */ /* OK */

    BP_NOT_DEFINED,                         /* usExtIntrAdslDyingGasp */ /* OK */
    BP_EXT_INTR_0,                          /* usExtIntrResetToDefault */ /* OK */
    BP_GPIO_2_AL,                           /* usExtIntrSesBtnWireless */ /* OK */
    BP_NOT_DEFINED,                         /* usExtIntrHpna */ /* OK */

    BP_NOT_DEFINED,                         /* usCsHpna */ /* OK */
    BP_NOT_DEFINED,                         /* usCsHpi */ /* OK */
    ...
    {{BP_VOIP_MIPS,                         /* ucDspType */
      ...
      BP_NOT_DEFINED,                       /* usGpioLedVoip */
      BP_NOT_DEFINED,                       /* usCsVoip */
      BP_SERIAL_GPIO_5_AL,                  /* usGpioVoip1Led */ /* OK */
      BP_NOT_DEFINED,                       /* usGpioVoip1LedFail */ /* OK */
      BP_NOT_DEFINED,                       /* usGpioSlic0Relay */ /* OK */
      BP_GPIO_21_AL,                        /* usGpioSlic0Reset */ /* OK */
      BP_SERIAL_GPIO_6_AL,                  /* usGpioVoip2Led */ /* OK */
      BP_NOT_DEFINED,                       /* usGpioVoip2LedFail */ /* OK */
      BP_NOT_DEFINED,                       /* usGpioSlic1Relay */ /* OK */
      BP_GPIO_21_AL,                        /* usGpioSlic1Reset */ /* OK */
      BP_NOT_DEFINED,                       /* usGpioPotsLed */ /* OK */
      BP_NOT_DEFINED,                       /* usGpioPotsReset */ /* OK */
      BP_NOT_DEFINED},                      /* usGpioDectLed */
     {BP_VOIP_NO_DSP}},                     /* ucDspType */
  Legerity_88221,                         /* SLIC type */
  Legerity_88010,                         /* DAA type */
...
static BOARD_PARAMETERS g_bcm96368mvwg =
{
    ...
    BP_NOT_DEFINED,                         /* usGpioLedWanData */
    BP_NOT_DEFINED,                         /* usGpioLedPpp */
    BP_GPIO_31_AH,                          /* usGpioLedPppFail */
...
static PBOARD_PARAMETERS g_BoardParms[] =
    {&g_bcm96368vvw, &g_bcm96368mvwg, &g_bcm96368sv2, &g_bcm96369pvg,
     &g_bcm96368mbg, 0};
#endif

#if defined(_BCM96816_) || defined(CONFIG_BCM96816)

static BOARD_PARAMETERS g_bcm96816r =
{
    "96816R",                               /* szBoardId */
    (0),                                    /* usGPIOOverlay */
...
static PBOARD_PARAMETERS g_BoardParms[] = {&g_bcm96816r, 0};
#endif
...
#else
static PBOARD_PARAMETERS g_pCurrentBp = &g_bcm96358vw;
#endif /* CONFIG_BOARD_NEUFBOX4 */
...
static WLAN_SROM_PATCH_INFO wlanPaInfo[]={{"96348W3-10", 0x4318, 49, {{"pa0b0", 47, 0x14ae},
                                                                   {"pa0b1", 48, 0xfad4},
                                                                   {"pa0b2", 49, 0xfe82},
                                                                   {"",       0,      0}}},
