...
static void __init set_mac_info( void )
{
    ...
    if( ulNumMacAddrs > 0 && ulNumMacAddrs <= NVRAM_MAC_COUNT_MAX )
    {
        ...
        if( g_pMacInfo )
        {
            ...
            g_pMacInfo->ulNumMacAddrs = 32/* nvramData.ulNumMacAddrs*/;
...
int kerSysGetMacAddress( unsigned char *pucaMacAddr, unsigned long ulId )
{
    ...
    board_get_mac_address(pucaMacAddr, ulId);
    return 0;
#endif /* !CONFIG_BOARD_NEUFBOX4 */
} /* kerSysGetMacAddr */
...
int kerSysGetWlanSromParams( unsigned char *wlanParams, unsigned short len)
{
     ...
     memcpy( wlanParams, (char *)&nvramData + ((size_t) &((NVRAM_DATA *)0)->wlanParams),
					len );
#else
    printk("WARNING! Wlan srom data not available\n");
#endif /* CONFIG_BOARD_NEUFBOX4 */
    return 0;
}
                        ...
                        unsigned int command, unsigned long arg )
{
    ...
    switch (command) 
    {
...
#else
                       printk("BOARD_IOCTL_FLASH_WRITE::SCRATCH_PAD\n");
                       BUG_ON(1);
#endif /* ! CONFIG_BOARD_NEUFBOX4 */
                        break;
...
#else
                       printk("BOARD_IOCTL_FLASH_WRITE::PERSISTENT\n");
                       BUG_ON(1);
#endif /* CONFIG_BOARD_NEUFBOX4 */
                        break;
...
#else
                       printk("BOARD_IOCTL_FLASH_WRITE::NVRAM\n");
                       BUG_ON(1);
#endif /* CONFIG_BOARD_NEUFBOX4 */
                        break;
...
#else
                       printk("BOARD_IOCTL_FLASH_READ::SCRATCH_PAD\n");
                       BUG_ON(1);
#endif /* CONFIG_BOARD_NEUFBOX4 */
                        break;
...
#else
                       printk("BOARD_IOCTL_FLASH_READ::PERSISTENT\n");
                       BUG_ON(1);
#endif /* CONFIG_BOARD_NEUFBOX4 */
                        break;
...
#else
                       printk("BOARD_IOCTL_FLASH_READ::NVRAM\n");
                       BUG_ON(1);
#endif /* CONFIG_BOARD_NEUFBOX4 */
                        break;
...
#else
                       printk("BOARD_IOCTL_FLASH_LIST::SCRATCH_PAD\n");
                       BUG_ON(1);
#endif /* CONFIG_BOARD_NEUFBOX4 */
                        break;
        ...
        case BOARD_IOCTL_GET_PSI_SIZE:
            ...
            ret = 0;
#else
	    printk("BOARD_IOCTL_GET_PSI_SIZE\n");
	    BUG_ON(1);
#endif /* !CONFIG_BOARD_NEUFBOX4 */
            break;
        ...
        case BOARD_IOCTL_GET_BASE_MAC_ADDRESS:
            ...
            if (copy_from_user((void*)&ctrlParms, (void*)arg, sizeof(ctrlParms)) == 0) 
            {
                ...
                ret = -EFAULT;
#else
	    printk("BOARD_IOCTL_GET_BASE_MAC_ADDRESS\n");
	    BUG_ON(1);
#endif /* !CONFIG_BOARD_NEUFBOX4 */
            break;
...
#endif	
#else
	    printk("BOARD_IOCTL_SET_MONITOR_FD\n");
	    BUG_ON(1);
#endif /* !CONFIG_BOARD_NEUFBOX4 */
            break;
...
#ifdef CONFIG_BOARD_NEUFBOX4
	    printk("BOARD_IOCTL_WAKEUP_MONITOR_TASK\n");
	    BUG_ON(1);
#else
...
#if 0 /* CONFIG_BOARD_NEUFBOX4 */
	    printk("BOARD_IOCTL_SET_GPIO\n");
	    BUG_ON(1);
            ret = 0;
#else
            if (copy_from_user((void*)&ctrlParms, (void*)arg, sizeof(ctrlParms)) == 0) {
