...
static inline int bcm63xx_get_irq_number(enum bcm63xx_irq irq)
{
	...
	switch(irq) {
	case IRQ_TIMER:
		return BCM_6338_TIMER_IRQ;
	case IRQ_UART0:
		return BCM_6338_UART0_IRQ;
	case IRQ_SPI:
		return BCM_6338_SPI_IRQ;
	case IRQ_DSL:
		return BCM_6338_DSL_IRQ;
	case IRQ_ENET0:
		return BCM_6338_ENET0_IRQ;
	case IRQ_ENET_PHY:
		return BCM_6338_ENET_PHY_IRQ;
	case IRQ_ENET0_RXDMA:
		return BCM_6338_ENET0_RXDMA_IRQ;
	case IRQ_ENET0_TXDMA:
		return BCM_6338_ENET0_TXDMA_IRQ;
	}
#endif
#ifdef CONFIG_BCM63XX_CPU_6348
	switch(irq) {
	case IRQ_TIMER:
		return BCM_6348_TIMER_IRQ;
	case IRQ_UART0:
		return BCM_6348_UART0_IRQ;
	case IRQ_SPI:
		return BCM_6348_SPI_IRQ;
	case IRQ_DSL:
		return BCM_6348_DSL_IRQ;
	case IRQ_ENET0:
		return BCM_6348_ENET0_IRQ;
	case IRQ_ENET1:
		return BCM_6348_ENET0_IRQ;
	case IRQ_ENET_PHY:
		return BCM_6348_ENET_PHY_IRQ;
	case IRQ_OHCI0:
		return BCM_6348_OHCI0_IRQ;
	case IRQ_ENET0_RXDMA:
		return BCM_6348_ENET0_RXDMA_IRQ;
	case IRQ_ENET0_TXDMA:
		return BCM_6348_ENET0_TXDMA_IRQ;
	case IRQ_ENET1_RXDMA:
		return BCM_6348_ENET1_RXDMA_IRQ;
	case IRQ_ENET1_TXDMA:
		return BCM_6348_ENET1_TXDMA_IRQ;
	case IRQ_PCI:
		return BCM_6348_PCI_IRQ;
	case IRQ_PCMCIA:
		return BCM_6348_PCMCIA_IRQ;
	}
	...
	switch(irq) {
	case IRQ_TIMER:
		return BCM_6358_TIMER_IRQ;
	case IRQ_UART0:
		return BCM_6358_UART0_IRQ;
	case IRQ_SPI:
		return BCM_6358_SPI_IRQ;
	case IRQ_DSL:
		return BCM_6358_DSL_IRQ;
	case IRQ_ENET0:
		return BCM_6358_ENET0_IRQ;
	case IRQ_ENET1:
		return BCM_6358_ENET0_IRQ;
	case IRQ_ENET_PHY:
		return BCM_6358_ENET_PHY_IRQ;
	case IRQ_OHCI0:
		return BCM_6358_OHCI0_IRQ;
	case IRQ_EHCI0:
		return BCM_6358_EHCI0_IRQ;
	case IRQ_ENET0_RXDMA:
		return BCM_6358_ENET0_RXDMA_IRQ;
	case IRQ_ENET0_TXDMA:
		return BCM_6358_ENET0_TXDMA_IRQ;
	case IRQ_ENET1_RXDMA:
		return BCM_6358_ENET1_RXDMA_IRQ;
	case IRQ_ENET1_TXDMA:
		return BCM_6358_ENET1_TXDMA_IRQ;
	case IRQ_PCI:
		return BCM_6358_PCI_IRQ;
	case IRQ_PCMCIA:
		return BCM_6358_PCMCIA_IRQ;
	default:
		return 0;
	}
#endif
