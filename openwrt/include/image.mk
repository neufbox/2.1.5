...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),y)
  ...
  ifeq ($(CONFIG_TARGET_ROOTFS_SQUASHFS),y)
    define Image/mkfs/squashfs
		...
		$(STAGING_DIR_HOST)/bin/fakeroot sh -c "$(PLATFORM_DIR)/image/mkdevices.sh $(TARGET_DIR) && \
		$(MKSQUASHFS_CMD) $(TARGET_DIR) $(KDIR)/root.squashfs -noappend -all-root $(SQUASHFS_OPTS)"
